...
@FeignClient(name = "cards", url = "http://cards:9000", fallback = CardFallback.class) // The value "cards" here is the same value where we have used to register with the Eureka Server
